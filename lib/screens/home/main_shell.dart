  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: _PremiumFAB(
          pulseScale: _pulseScale, pulseOpacity: _pulseOpacity),
...
class _PremiumNavBar extends StatelessWidget {
  ...
  static const _items = [
    _NavItemData(icon: Icons.home_outlined, activeIcon: Icons.home_rounded,
        label: 'Home'),
    _NavItemData(icon: Icons.menu_book_outlined,
        activeIcon: Icons.menu_book_rounded, label: 'Diary'),
    _NavItemData(icon: Icons.psychology_outlined,
        activeIcon: Icons.psychology_rounded, label: 'Coach'),
    _NavItemData(icon: Icons.bar_chart_outlined,
