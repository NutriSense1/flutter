            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                if (scanHistory.isNotEmpty) ...[
                  FadeSlide(
                    delay: d * 5,
                    child: RecentScansCard(scans: scanHistory.take(5).toList()),
                  ),
                  const SizedBox(height: 16),
                ],
                FadeSlide(
...
class _HomeHeader extends StatelessWidget {
  ...
  const _HomeHeader({required this.greeting, required this.name, required this.onProfileTap});
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(greeting, style: AppTypography.bodySmall.copyWith(color: secondaryTxt)),
            ...
            AnimatedTap(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: AppColors.primary.withOpacity(0.30), blurRadius: 10, offset: const Offset(0, 4))],
                ),
                child: Center(
                  child: Text(
...
class _WeightProgressTile extends StatelessWidget {
  ...
  const _WeightProgressTile({required this.currentWeight, required this.goalWeight, required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    final trackBg      = isDark ? AppColors.darkSurfaceVariant : AppColors.surfaceVariant;
    final secondaryTxt = isDark ? AppColors.darkTextSecondary : AppColors.textSecondary;
    final hintIcon     = isDark ? AppColors.darkTextSecondary : AppColors.textHint;
    final iconBg       = isDark
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.monitor_weight_outlined, color: AppColors.primary, size: 26),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: AppTypography.bodySmall.copyWith(color: secondaryTxt),
                  ),
                  ...
                  ClipRRect(
                    ...
                    child: Stack(
                      children: [
                        Container(height: 6, color: trackBg),
                        FractionallySizedBox(
                          widthFactor: progress.clamp(0.0, 1.0),
                          child: Container(
                            height: 6,
                            decoration: const BoxDecoration(
                              gradient: LinearGradient(colors: [Color(0xFF34D47A), AppColors.primary]),
                            ),
                          ),
                        ),
                      ],
            ...
            Icon(Icons.chevron_right_rounded, color: hintIcon),
          ],
        ),
      ),
    );
